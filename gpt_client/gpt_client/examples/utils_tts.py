...
def tts(TEXT='我是湖南大学共融双臂配药机器人', tts_wav_path = '/home/gcj/robochain-main/gpt_client/gpt_client/examples/temp/tts.wav'):
    '''
    语音合成TTS，生成wav音频文件
    '''
...
def play_wav(wav_file='/home/gcj/robochain-main/gpt_client/gpt_client/examples/asset/welcome.wav'):
    '''
    播放wav音频文件
    '''
