...
def record_auto(MIC_INDEX=1):
    ...
    # 导出wav音频文件
    output_path = '/home/gcj/robochain-main/gpt_client/gpt_client/examples/temp/speech_record.wav'
...
def speech_recognition(audio_path='/home/gcj/robochain-main/gpt_client/gpt_client/examples/temp/speech_record.wav'):
    '''
