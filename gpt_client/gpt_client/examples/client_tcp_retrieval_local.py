...
def main(args=None):
    ...
    while True:
        ...
        time.sleep(2)
        print(colors.GREEN + "机器人🤖> " + colors.RED + "------机器人连接失败！！！")
        
        # time.sleep(3)
        # print(colors.GREEN + "机器人🤖> " + colors.BLUE + "------机器人执行任务指令🕛～～～")
        
        # time.sleep(10)
        # print(colors.GREEN + "机器人🤖> " + colors.BLUE + "------完成任务🏹")
        
        # time.sleep(2)
        # print(colors.GREEN + "机器人🤖> " + colors.BLUE + "------请做下一步指示👈")
